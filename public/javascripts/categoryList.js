...
$(document).ready(function(){
    ...
    $categoryCreateModalBtn.click(function(e){
        ...
        if(cm_name.length > 0 && cm_desc.length > 0 && picPath.length > 0) {
            ...
            $.post("/admin/api/category/create",{name: cm_name, desc: cm_desc, picPath: picPath},function(result){
                self.waiting('done');
                if(result.success) {
                    $("#category-name").val('');
                    $("#category-description").val('');
                    ...
                    var hrefURL = "/admin/page/categoryList/sub?objectId=" + result.objectId+"&name=" + cm_name + "&desc=" + cm_desc + "&picpath=" + picPath;
    ...
    $categoryUpdateModalBtn.click(function(e){
        ...
        if(cm_name.length > 0 && cm_desc.length > 0 && picPath.length > 0) {
            ...
            $.post("/admin/api/category/update", postData, function(result){
                self.waiting('done');
                if(result.success) {
                    $("#category-name").val('');
                    $("#category-description").val('');
                    ...
                    var hrefURL = "/admin/page/categoryList/sub?objectId=" + objectId+"&name=" + cm_name + "&desc=" + cm_desc + "&picpath=" + picPath;
    ...
    //     e.preventDefault()
    //     var sender = $(this);
    //     var objectId = sender.attr("objectid");
